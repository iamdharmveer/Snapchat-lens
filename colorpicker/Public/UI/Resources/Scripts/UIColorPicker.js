...
//@ui {"widget":"separator"}
//@input Component.MeshVisual alphaRecipient
...
// Update color visuals based on the selected alpha
function updateAlphaVisual() {
    if (script.alphaRecipient) {
        const baseColor = script.alphaRecipient.mainPass.baseColor;
        script.alphaRecipient.mainPass.baseColor = new vec4(baseColor.r, baseColor.g, baseColor.b, currentColor.r);
    }
}
